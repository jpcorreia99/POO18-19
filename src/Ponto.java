...
public class Ponto implements Serializable {
   ...
   */
  public void movePonto(Ponto p) {
    this.x = p.getX();  // ou setX(cx)
    this.y = p.getY();  // ou this.setY(cy)
  }
  ...
  public String toString(){
      ...
      double posX = (double)Math.round(x* 100d) / 100d;
      double posY = (double)Math.round(y * 100d) / 100d;
